...
- If not present, initialize them based on the Nexus-APCP standard.
...
2. **Inject into Project**: Copy `AI_MAIN.md`, `TASK_PROGRESS.yaml`, and `scripts/` to your project root.
