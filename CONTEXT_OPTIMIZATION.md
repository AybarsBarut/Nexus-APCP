...
## 🎯 The Problem
As a software project grows, the codebase and documentation eventually exceed the context window (token limit) of AI models. This results in the AI "forgetting" critical rules or making inconsistent decisions.

## 🧩 Modular Context Strategy

### Level 1: Standard (Bootstrap Mode)
**Usage**: When starting a new session or a new project.
- **Files**: Full `AI_PROJECT_CONTEXT.md` + Full `TASK_PROGRESS.yaml`.
...
- **Rules**: `AI_PROJECT_CONTEXT.md` (Sections 1-6 only: Identity, Hierarchy, Imports, Security, Patterns, Git).
...
- **Identity**: `AI_PROJECT_CONTEXT.md` (Section 1 and 2 only).
